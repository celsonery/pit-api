...
/* doc-index.twig */
class __TwigTemplate_a48a94077704f8e15658342cfb9025c3 extends Template
{
    private $source;
        ...
        <dl id="index';
            ...
            foreach ($context['_seq'] as $context['_key'] => $context['element']) {
                ...
                if (('class' == (isset($context['type']) || array_key_exists('type', $context) ? $context['type'] : (function () {
                    ...
                    // line 29
                    echo '<dt>';
                    echo twig_call_macro($macros['__internal_parse_7'], 'macro_class_link', [(isset($context['value']) || array_key_exists('value', $context) ? $context['value'] : (function () {
...
(isset($context['type']) || array_key_exists('type', $context) ? $context['type'] : (function () {
    throw new RuntimeError('Variable "type" does not exist.', 33, $this->source);
                    ...
                    // line 34
                    echo '<dt>';
                    echo twig_call_macro($macros['__internal_parse_7'], 'macro_method_link', [(isset($context['value']) || array_key_exists('value', $context) ? $context['value'] : (function () {
...
(isset($context['type']) || array_key_exists('type', $context) ? $context['type'] : (function () {
    throw new RuntimeError('Variable "type" does not exist.', 38, $this->source);
                    ...
                    // line 39
                    echo '<dt>$';
                    echo twig_call_macro($macros['__internal_parse_7'], 'macro_property_link', [(isset($context['value']) || array_key_exists('value', $context) ? $context['value'] : (function () {
...
{% block page_content %}
    ...
    {%- endfor %}
{% endblock %}
", 'doc-index.twig', 'phar:///home/celso/Devel/projects/oregon/pit/api/doctum.phar/src/Resources/themes/default/doc-index.twig');
    }
}
