...
/* layout/layout.twig */
class __TwigTemplate_bc4b19d8a805eaaf8c2abafc12cdaf2a extends Template
{
    private $source;
...
';
    ...
    public function block_menu($context, array $blocks = [])
    {
        ...
        })()), 'config', ['title'], 'method', false, false, false, 30), 'html', null, true);
        echo '</a>
            </div>
        ...
        if ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context['project']) || array_key_exists('project', $context) ? $context['project'] : (function () {
            throw new RuntimeError('Variable "project" does not exist.', 34, $this->source);
        })()), 'versions', [], 'any', false, false, false, 34)) > 1)) {
            // line 35
            ...
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context['project']) || array_key_exists('project', $context) ? $context['project'] : (function () {
                throw new RuntimeError('Variable "project" does not exist.', 41, $this->source);
            })()), 'versions', [], 'any', false, false, false, 41));
            foreach ($context['_seq'] as $context['_key'] => $context['version']) {
                // line 42
                echo '<li ';
                echo (($context['version'] == twig_get_attribute($this->env, $this->source, (isset($context['project']) || array_key_exists('project', $context) ? $context['project'] : (function () {
                    throw new RuntimeError('Variable "project" does not exist.', 42, $this->source);
                })()), 'version', [], 'any', false, false, false, 42))) ? ('class="active"') : ('');
                echo '><a href="';
        ...
        if ((isset($context['has_namespaces']) || array_key_exists('has_namespaces', $context) ? $context['has_namespaces'] : (function () {
            throw new RuntimeError('Variable "has_namespaces" does not exist.', 48, $this->source);
        })())) {
            // line 49
            echo '<li><a href="';
...
';
    ...
    public function block_control_panel($context, array $blocks = [])
    {
        ...
        // line 67
        if ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context['project']) || array_key_exists('project', $context) ? $context['project'] : (function () {
            throw new RuntimeError('Variable "project" does not exist.', 67, $this->source);
        })()), 'versions', [], 'any', false, false, false, 67)) > 1)) {
            // line 68
            echo '            <form action="#">
            ...
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context['project']) || array_key_exists('project', $context) ? $context['project'] : (function () {
                throw new RuntimeError('Variable "project" does not exist.', 70, $this->source);
            })()), 'versions', [], 'any', false, false, false, 70));
            foreach ($context['_seq'] as $context['_key'] => $context['version']) {
                // line 71
                echo '                        <option
                            value="';
                ...
                echo '" ';
                echo (($context['version'] == twig_get_attribute($this->env, $this->source, (isset($context['project']) || array_key_exists('project', $context) ? $context['project'] : (function () {
                    throw new RuntimeError('Variable "project" does not exist.', 73, $this->source);
                })()), 'version', [], 'any', false, false, false, 73))) ? ('selected') : ('');
                echo '>';
...
';
    ...
    public function block_footer($context, array $blocks = [])
    {
        ...
        if (twig_get_attribute($this->env, $this->source, (isset($context['project']) || array_key_exists('project', $context) ? $context['project'] : (function () {
            throw new RuntimeError('Variable "project" does not exist.', 105, $this->source);
        })()), 'hasFooterLink', [], 'method', false, false, false, 105)) {
            // line 106
            $context['link'] = twig_get_attribute($this->env, $this->source, (isset($context['project']) || array_key_exists('project', $context) ? $context['project'] : (function () {
                throw new RuntimeError('Variable "project" does not exist.', 106, $this->source);
            })()), 'getFooterLink', [], 'method', false, false, false, 106);
            // line 107
            echo '            <br/>';
            // line 108
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context['link']) || array_key_exists('link', $context) ? $context['link'] : (function () {
                throw new RuntimeError('Variable "link" does not exist.', 108, $this->source);
            })()), 'before_text', [], 'any', false, false, false, 108), 'html', null, true);
            // line 109
            if (! twig_test_empty(twig_get_attribute($this->env, $this->source, (isset($context['link']) || array_key_exists('link', $context) ? $context['link'] : (function () {
                throw new RuntimeError('Variable "link" does not exist.', 109, $this->source);
            })()), 'href', [], 'any', false, false, false, 109))) {
                // line 110
                echo ' ';
                echo '<a href="';
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context['link']) || array_key_exists('link', $context) ? $context['link'] : (function () {
                    throw new RuntimeError('Variable "link" does not exist.', 110, $this->source);
                })()), 'href', [], 'any', false, false, false, 110), 'html', null, true);
                echo '" rel="';
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context['link']) || array_key_exists('link', $context) ? $context['link'] : (function () {
                    throw new RuntimeError('Variable "link" does not exist.', 110, $this->source);
                })()), 'rel', [], 'any', false, false, false, 110), 'html', null, true);
                echo '" target="';
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context['link']) || array_key_exists('link', $context) ? $context['link'] : (function () {
                    throw new RuntimeError('Variable "link" does not exist.', 110, $this->source);
                })()), 'target', [], 'any', false, false, false, 110), 'html', null, true);
                echo '">';
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context['link']) || array_key_exists('link', $context) ? $context['link'] : (function () {
                    throw new RuntimeError('Variable "link" does not exist.', 110, $this->source);
                })()), 'link_text', [], 'any', false, false, false, 110), 'html', null, true);
                echo '</a>';
                echo ' ';
            }
            // line 112
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context['link']) || array_key_exists('link', $context) ? $context['link'] : (function () {
                throw new RuntimeError('Variable "link" does not exist.', 112, $this->source);
            })()), 'after_text', [], 'any', false, false, false, 112), 'html', null, true);
        }
        // line 114
        echo '</div>';
    }
...
{%- endblock -%}
", 'layout/layout.twig', 'phar:///home/celso/Devel/projects/oregon/pit/api/doctum.phar/src/Resources/themes/default/layout/layout.twig');
    }
}
