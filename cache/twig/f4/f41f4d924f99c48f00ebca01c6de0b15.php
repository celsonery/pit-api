...
/* namespace.twig */
class __TwigTemplate_a016197b1ae6fc693d21affd8bd0ef3f extends Template
{
    private $source;
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        ((((isset($context['namespace']) || array_key_exists('namespace', $context) ? $context['namespace'] : (function () {
            throw new RuntimeError('Variable "namespace" does not exist.', 3, $this->source);
    ...
    public function block_page_id($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, ('namespace:'.twig_replace_filter(((((isset($context['namespace']) || array_key_exists('namespace', $context) ? $context['namespace'] : (function () {
            throw new RuntimeError('Variable "namespace" does not exist.', 5, $this->source);
        })()) == '')) ? (Doctum\Tree::getGlobalNamespacePageName()) : ((isset($context['namespace']) || array_key_exists('namespace', $context) ? $context['namespace'] : (function () {
            throw new RuntimeError('Variable "namespace" does not exist.', 5, $this->source);
        })()))), ['\\' => '_'])), 'html', null, true);
    }
    ...
    public function block_below_menu($context, array $blocks = [])
    {
        ...
        echo '</span></li>
            ';
        // line 11
        echo twig_call_macro($macros['__internal_parse_12'], 'macro_breadcrumbs', [(isset($context['namespace']) || array_key_exists('namespace', $context) ? $context['namespace'] : (function () {
            throw new RuntimeError('Variable "namespace" does not exist.', 11, $this->source);
        })())], 11, $context, $this->getSourceContext());
        echo '
        </ol>
    </div>
';
    ...
    <div class="page-header">
        ...
        // line 19
        ((((isset($context['namespace']) || array_key_exists('namespace', $context) ? $context['namespace'] : (function () {
            throw new RuntimeError('Variable "namespace" does not exist.', 19, $this->source);
        })()) == '')) ? (print twig_escape_filter($this->env, Doctum\Tree::getGlobalNamespaceName(), 'html', null, true)) : (print isset($context['namespace']) || array_key_exists('namespace', $context) ? $context['namespace'] : (function () {
            throw new RuntimeError('Variable "namespace" does not exist.', 19, $this->source);
        })()));
        echo '</h1>
    ...
    ';
        // line 22
        if ((isset($context['subnamespaces']) || array_key_exists('subnamespaces', $context) ? $context['subnamespaces'] : (function () {
            throw new RuntimeError('Variable "subnamespaces" does not exist.', 22, $this->source);
        })())) {
            // line 23
            echo '        <h2>';
        ...
        <div class="namespace-list">
            ...
            $context['_seq'] = twig_ensure_traversable((isset($context['subnamespaces']) || array_key_exists('subnamespaces', $context) ? $context['subnamespaces'] : (function () {
                throw new RuntimeError('Variable "subnamespaces" does not exist.', 25, $this->source);
            })()));
    ...
    ';
        // line 29
        if ((isset($context['classes']) || array_key_exists('classes', $context) ? $context['classes'] : (function () {
            throw new RuntimeError('Variable "classes" does not exist.', 29, $this->source);
        })())) {
            // line 30
            echo '        <h2>';
            ...
            echo '</h2>';
            // line 31
            echo twig_call_macro($macros['__internal_parse_12'], 'macro_render_classes', [(isset($context['classes']) || array_key_exists('classes', $context) ? $context['classes'] : (function () {
                throw new RuntimeError('Variable "classes" does not exist.', 31, $this->source);
    ...
    ';
        // line 34
        if ((isset($context['interfaces']) || array_key_exists('interfaces', $context) ? $context['interfaces'] : (function () {
            throw new RuntimeError('Variable "interfaces" does not exist.', 34, $this->source);
        })())) {
            // line 35
            echo '        <h2>';
            ...
            echo '</h2>';
            // line 36
            echo twig_call_macro($macros['__internal_parse_12'], 'macro_render_classes', [(isset($context['interfaces']) || array_key_exists('interfaces', $context) ? $context['interfaces'] : (function () {
                throw new RuntimeError('Variable "interfaces" does not exist.', 36, $this->source);
    ...
    ';
        // line 39
        if ((isset($context['functions']) || array_key_exists('functions', $context) ? $context['functions'] : (function () {
            throw new RuntimeError('Variable "functions" does not exist.', 39, $this->source);
        })())) {
            // line 40
            echo '        <h2>';
        ...
        <div class="container-fluid underlined">
            ...
            // line 43
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable((isset($context['functions']) || array_key_exists('functions', $context) ? $context['functions'] : (function () {
                throw new RuntimeError('Variable "functions" does not exist.', 43, $this->source);
            })()));
            foreach ($context['_seq'] as $context['_key'] => $context['function']) {
                ...
                echo '                    </div>
                    <div class="col-md-2">
                        <div class="location">';
                // line 69
                if (! (twig_get_attribute($this->env, $this->source, $context['function'], 'namespace', [], 'any', false, false, false, 69) === (isset($context['namespace']) || array_key_exists('namespace', $context) ? $context['namespace'] : (function () {
                    throw new RuntimeError('Variable "namespace" does not exist.', 69, $this->source);
                })()))) {
                    // line 70
                    echo '<em><a href="';
    ...
    ';
        // line 79
        if ((isset($context['exceptions']) || array_key_exists('exceptions', $context) ? $context['exceptions'] : (function () {
            throw new RuntimeError('Variable "exceptions" does not exist.', 79, $this->source);
        })())) {
            // line 80
            echo '        <h2>';
            ...
            echo '</h2>';
            // line 81
            echo twig_call_macro($macros['__internal_parse_12'], 'macro_render_classes', [(isset($context['exceptions']) || array_key_exists('exceptions', $context) ? $context['exceptions'] : (function () {
                throw new RuntimeError('Variable "exceptions" does not exist.', 81, $this->source);
            })())], 81, $context, $this->getSourceContext());
        }
        // line 83
        echo '
';
...
{% endblock %}
", 'namespace.twig', 'phar:///home/celso/Devel/projects/oregon/pit/api/doctum.phar/src/Resources/themes/default/namespace.twig');
    }
}
