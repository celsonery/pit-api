...
/* layout/base.twig */
class __TwigTemplate_6373ed16b6c32746fd03d0253a1c0359 extends Template
{
    private $source;
...
<html lang="';
        ...
        })()), 'config', ['language'], 'method', false, false, false, 2), 'html', null, true);
        echo '">
<head>
    <meta charset="UTF-8" />
...
';
        ...
        })()), 'config', ['favicon'], 'method', false, false, false, 22)) {
            // line 23
            echo '        <link rel="shortcut icon" href="';
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context['project']) || array_key_exists('project', $context) ? $context['project'] : (function () {
                throw new RuntimeError('Variable "project" does not exist.', 23, $this->source);
            })()), 'config', ['favicon'], 'method', false, false, false, 23), 'html', null, true);
            echo '" />';
        }
        // line 25
        echo '
    ...
    ';
                ...
                })()), 'config', ['title'], 'method', false, false, false, 31), 'html', null, true);
                echo ' (';
...
", 'layout/base.twig', 'phar:///home/celso/Devel/projects/oregon/pit/api/doctum.phar/src/Resources/themes/default/layout/base.twig');
    }
}
